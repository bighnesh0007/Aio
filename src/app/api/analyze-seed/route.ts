...
export async function POST(request: Request) {
  try {
    ...
    const result = await model.generateContent([
      `Analyze the seed quality in this image. Respond with exactly one word from the following options: Excellent, Good, Fair, or Poor. Do not include any additional text or explanation.`,
      {
        inlineData: {
          mimeType: 'image/jpeg',
